...
class NavWalker extends \Walker_Nav_Menu {
  ...
  public function cssClasses($classes, $item) {
    ...
    $classes = preg_replace('/(current(-menu-|[-_]page[-_])(parent|ancestor))/', 'active dp-parent', $classes);
    $classes = preg_replace('/(current(-menu-|[-_]page[-_])(item))/', 'active dp-active', $classes);
